...
def save_level():
    ...
    conn.commit()
    conn.close()
    return {"status": "ok", "last_activity": now_str, "selected_level": db_level, "current_lesson": current_lesson}
...
def get_lesson():
    ...
    try:
        import website.b1_lessons as b1_mod
        B1_LESSONS = b1_mod.B1_LESSONS
    except ImportError:
        try:
            import b1_lessons as b1_mod
            B1_LESSONS = b1_mod.B1_LESSONS
        except ImportError:
            B1_LESSONS = {}
